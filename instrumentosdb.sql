...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2024 a las 23:50:20
...
INSERT INTO `instrumento` (`id`, `instrumento`, `marca`, `modelo`, `imagen`, `precio`, `costoEnvio`, `cantidadVendida`, `descripcion`) VALUES
...
(2, 'Pandereta Pandero Instrumento Musical', 'DyM ventas', '32 sonajas', 'nro9.jpg', 325.00, 150.00, 10, '1 Pandereta - 32 sonajas metálicas. Más de 8 años vendiendo con 100 % de calificaciones POSITIVAS y clientes satisfechos !! '),
(3, 'Triangulo Musical 24 Cm Percusion', 'LBP', '24', 'nro8.jpg', 260.00, 250.00, 3, 'Triangulo Musical de 24 Centímetros De Acero. ENVIOS POR CORREO O ENCOMIENDA: Se le deberán adicionar $40 en concepto de Despacho y el Costo del envío se abonará al recibir el producto en Terminal, Sucursal OCA o Domicilio'),
(4, 'Bar Chimes Lp Cortina Musical 72 Barras', 'FM', 'LATIN', 'nro7.jpg', 2250.00, 0.00, 2, 'BARCHIME CORTINA MUSICAL DE 25 BARRAS LATIN CUSTOM. Emitimos factura A y B'),
...
(6, 'Antiguo Piano Aleman Con Candelabros.', 'Neumeyer', 'Stratus', 'nro3.jpg', 17000.00, 2000.00, 0, 'Buen dia! Sale a la venta este Piano Alemán Neumeyer con candelabros incluidos. Tiene una talla muy bonita en la madera. Una pieza de calidad.'),
(7, 'Guitarra Ukelele Infantil Grande 60cm', 'GUITARRA', 'UKELELE', 'nro4.jpg', 500.00, 0.00, 5, 'Material: Plástico smil madera 4 Cuerdas longitud: 60cm, el mejor regalo para usted, su familia y amigos, adecuado para 3-18 años de edad'),
...
(10, 'Batería Musical Infantil Juguete Niño 9 Piezas Palillos', 'Bateria', 'Infantil', 'nro5.jpg', 850.00, 250.00, 380, 'DESCRIPCIÓN: DE 1 A 3 AÑOS. EL SET INCLUYE 5 TAMBORES, PALILLOS Y EL PLATILLO TAL CUAL LAS FOTOS. SONIDOS REALISTAS Y FÁCIL DE MONTAR. MEDIDAS: 40X20X46 CM');
COMMIT;
